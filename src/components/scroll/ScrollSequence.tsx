 ...
 *
 * Uses position: sticky with 130vh container for pinned scroll effect.
 * The extra scroll room allows the next section to slide up smoothly
 * and appear just below the scaled video.
 */
